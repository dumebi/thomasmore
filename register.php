							...
							<section class="process-section anim-section text-center">
								...
								<div class="row processes">
									<div class="col-xs-12 col-sm-3">
										...
										<h3 class="h4">Click the Register Button</h3>
										<p>
									...
									<div class="col-xs-12 col-sm-3">
										...
										<h3 class="h4">Fill and Submit the form</h3>
										<p>
											Consectetur adipiscing elit Integer feugiat dolor nibh cum sociis natoque penatibus et magnis dis parturient montes
										</p>
									</div>
									<div class="col-xs-12 col-sm-3">
										...
										<h3 class="h4">Pay your registration fee</h3>
										<p>
											Consectetur adipiscing elit Integer feugiat dolor nibh cum sociis natoque penatibus et magnis dis parturient montes
										</p>
									</div>
									<div class="col-xs-12 col-sm-3">
										...
										<h3 class="h4">Collect your Membership card</h3>
										<p>
											Consectetur adipiscing elit Integer feugiat dolor nibh cum sociis natoque penatibus et magnis dis parturient montes
										</p>
									</div>
								...
								<p class="text-center">
									<a data-toggle="modal" href="external.php" data-target=".join-now-form" class="btn btn-default btn-lg join-today">Register</a>
								</p>
							</section>
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<header class="page-header">
							<h2>Fill The <strong>Form</strong></h2>
						</header>
					</div>
						...
						<form role="form">
							...
							<div class="row">
								<div class="col-xs-12">
									<div class="form-group col-xs-12">
										<p class="forms-notes">
											Note: Your registration does not end here. Pls endeavor to pay your registration fee
										</p>
									</div>
								</div>
							</div>
